...
router.get('/querypageteacher' , function(req,res){
    items=[];
    ...
    db.query(sql,function(err,result,fields){
        ...
        console.log(items);
        res.render("teacher-querypage",{newListItem: items});
    });
});

router.post("/teacherquerypage",function(req,res,next){
    item=req.body;
    console.log(item);
